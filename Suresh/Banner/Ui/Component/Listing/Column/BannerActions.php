...
namespace Suresh\Banner\Ui\Component\Listing\Column;
...
{
    private const URL_PATH_EDIT = 'banner/banner/edit';
    private const URL_PATH_DELETE = 'banner/banner/delete';
    ...
    {
        return $this->urlBuilder->getUrl(self::URL_PATH_EDIT, ['banner_id' => $item['banner_id']]);
    }
    ...
    {
        return $this->urlBuilder->getUrl(self::URL_PATH_DELETE, ['banner_id' => $item['banner_id']]);
    }
}
